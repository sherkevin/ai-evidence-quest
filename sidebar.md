...
- 第三编：向量检索与工程扩展
  - [分块、元数据与召回](chapters/07-chunking-and-metadata.md)
  - [Embedding 与向量搜索](chapters/08-embedding-and-vector-search.md)
  - [向量数据库](chapters/09-vector-database.md)
  - [重排与评测](chapters/10-rerank-and-evaluation.md)

- 第四编：课程交付
  - [校园项目实施](chapters/11-school-project.md)
  - [结课作品](chapters/12-capstone.md)
